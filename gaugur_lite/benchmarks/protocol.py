...
# 该标识只描述由两轮完整 5-repeat campaign 派生的分母数据集；它不是可执行
# worker 协议，因此不得加入 SUPPORTED_STABLE_BENCHMARK_PROTOCOLS。
POOLED_CALIBRATION_PROTOCOL = "pooled_full_campaigns_2x5_cv10_rse5_drift10_v3"
...
POOLED_CALIBRATION_REPEATS = 10
POOLED_DENOMINATOR_RSE_THRESHOLD_PCT = 5.0
POOLED_CAMPAIGN_DRIFT_THRESHOLD_PCT = 10.0
